...
\33[1;41m      \33[0m
\x1b[1;97m---------------------------------------------------
\x1b[1;97m[+]  AUTHOR :   Md Suman Hossain
\x1b[1;97m[+]  FACEBOOK :  Md Suman Hossain
\x1b[1;97m[+]  GITHUB :  SUMAN
\x1b[1;97m[+]  GROUP :  \33[1;42 SUMAN TOUCH BD \33[0m
\x1b[1;97m[+]       
\x1b[1;97m--------------------------------------  '''
...
def result():
	...
	if kz in ['1','01']:
		try:vin = os.listdir('CP')
			...
			back()
		if len(vin)==0:
			print('➥➥➣Anda Tidak Memiliki Suman CP ')
			time.sleep(2)
			back()
		else:
			cih = 0
		...
		if len(vin)==0:
			...
			for cpku in range(len(lin)):
				cpkuni=lin[nocp].split('|')
				cpkuh=f'# ID : {cpkuni[0]} PASSWORD : {cpkuni[1]}'
				sol().print(mark(cpkuh,style="purple"))
...
def Subscraption():
	...
	if key1 in r1:
		...
		print(logo)
		print ("")
		print(" \033[1;32m SUMAN Tool Paid You Need Get Approved First\033[1;37m\n")
		print ("")
		...
		os.system('am start https://wa.me/+8801934031767?text=' + tks)
		Subscraption()        
Subscraption()
